...
public class AppFlappyBird implements InterfaceFlappyBird{
    ...
    @Override
    public void dibujarNumero(int num, float x, float y, float size, float r, float g, float b) {
    ...
    @Override
    public void dibujarRectangulo(float x, float y, float ancho, float alto, float r, float g, float b, float rotation) {
